...
import { getMemberWithGym, getMemberMemberships, getMemberAttendance } from '@/lib/member-data'
...
import type { Achievement, AchievementRarity, MemberStats } from '@/lib/achievements/types'
